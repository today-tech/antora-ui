...
For a complete listing of valid categories and ids view https://github.com/today-tech/antora-ui/blob/main/src/helpers/related_projects.js[related_projects.js]
...
To include this resource, ensure that the https://github.com/today-tech/antora-extensions/blob/main/README.adoc[antora-extensions] is using 1.7.0+ and the https://github.com/today-tech/antora-extensions/blob/main/README.adoc#static-page[Static Page Extension] is included.
